...
class AppLocale {
  ...
  static const Map<String, Map<String, String>> _allStrings = {
    'kn': {
      ...
      'cancel': 'ರದ್ದು', 'yesChange': 'ಹೌದು, ಬದಲಾಯಿಸಿ', 'migrateSuccess': 'ಸಾಧನ ಯಶಸ್ವಿಯಾಗಿ ಬದಲಾಯಿಸಲಾಗಿದೆ!', 'failed': 'ವಿಫಲವಾಗಿದೆ',
    ...
    'hi': {
      ...
      'cancel': 'रद्द करें', 'yesChange': 'हाँ, बदलें', 'migrateSuccess': 'डिवाइस सफलतापूर्वक बदला गया!', 'failed': 'विफल',
    ...
    'ta': {
      ...
      'cancel': 'ரத்து', 'yesChange': 'ஆம், மாற்று', 'migrateSuccess': 'சாதனம் வெற்றிகரமாக மாற்றப்பட்டது!', 'failed': 'தோல்வி',
    ...
    'te': {
      ...
      'cancel': 'రద్దు', 'yesChange': 'అవును, మార్చు', 'migrateSuccess': 'పరికరం విజయవంతంగా మార్చబడింది!', 'failed': 'విఫలం',
    ...
    'ml': {
      ...
      'cancel': 'റദ്ദാക്കുക', 'yesChange': 'അതെ, മാറ്റുക', 'migrateSuccess': 'ഉപകരണം വിജയകരമായി മാറ്റി!', 'failed': 'പരാജയം',
