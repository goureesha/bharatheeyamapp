...
const Map<String, Map<String, String>> _vastuStrings = {
  ...
  'en': {
    'title': 'Vastu Measurements', 'sub': '',
    'tabParidhi': 'Perimeter (Feet)', 'paridhiHint': 'Enter building perimeter in feet', 'sqftHintNew': 'Enter area in Sq Ft',
    'ownerNak': 'Owner\'s Nakshatra', 'selectNak': 'Select Nakshatra',
    'length': 'Length (Feet)', 'breadth': 'Breadth (Feet)', 'area': 'Area (Sq Ft)',
    'tabLB': 'Length × Breadth (L × B)', 'tabSqft': 'Area (Sq Ft)',
    'search': 'Search', 'goodOnly': 'Good results only',
    'allResults': 'All results', 'noResults': 'No good results found',
    'hint': 'Enter details and search', 'hintEn': '',
    'sqftHint': 'Possible Length × Breadth pairs for each Sq Ft will be searched (min side: 5 ft)',
    'formula': 'Shastra Formula:',
    'peridhi': 'Perimeter', 'hasta': 'Hasta',
    'aaya': 'Aaya', 'vyaya': 'Vyaya',
    'buildingNak': 'Building Nakshatra', 'tarabala': 'Tarabala',
    'shubha': 'Auspicious', 'aayaGt': 'Aaya > Vyaya ✓', 'aayaLe': 'Aaya ≤ Vyaya ✗',
    'selectNakErr': 'Select Owner\'s Nakshatra',
    'yoni': 'Yoni', 'tithi': 'Tithi', 'vaara': 'Vaara',
    'adi': 'Feet', 'sqAdi': 'Sq Ft', 'all': 'All',
    'minLabel': 'Minimum', 'maxLabel': 'Maximum',
    'fromLabel': 'From', 'toLabel': 'To',
    'errMinMax': 'Minimum ≤ Maximum is required',
    'errRange': 'Range is too large, reduce it',
    'errMaxSqft': 'Maximum 5000 Sq Ft',
    'koluType': 'Kolu Type', 'angula': 'Angula', 'custom': 'Custom', 'koluName': 'Kolu Name',
    'kishku': 'Kishku', 'prajapatya': 'Prajapatya', 'dhanurmushti': 'Dhanurmushti', 'dhanugraha': 'Dhanugraha',
    'prachya': 'Prachya', 'vaideha': 'Vaideha', 'vaipulya': 'Vaipulya', 'prakeerna': 'Prakeerna',
    'vayassu': 'Vayassu', 'v0': 'Bala', 'v1': 'Kaumara', 'v2': 'Yauvana', 'v3': 'Madhyarka', 'v4': 'Nidhana',
    'vaara0': 'Sunday', 'vaara1': 'Monday', 'vaara2': 'Tuesday', 'vaara3': 'Wednesday', 'vaara4': 'Thursday', 'vaara5': 'Friday', 'vaara6': 'Saturday',
    'a1': 'Dhwaja', 'a2': 'Dhumra', 'a3': 'Simha', 'a4': 'Shwana', 'a5': 'Vrushabha', 'a6': 'Khara', 'a7': 'Gaja', 'a8': 'Dhwanksha',
    't1': 'Janma Tara', 't2': 'Sampat Tara', 't3': 'Vipat Tara', 't4': 'Kshema Tara',
    't5': 'Pratyak Tara', 't6': 'Sadhana Tara', 't7': 'Naidhana Tara', 't8': 'Mitra Tara', 't9': 'Parama Mitra Tara',
    'q1': 'Normal', 'q2': 'Excellent', 'q3': 'Bad', 'q4': 'Good',
  },
};
            ...
            children: [
              ...
              Expanded(
                child: _inputMode == 0
                  ...
                  : Text('${_v('area')}: ${((r.perimeterCm / 30.48 / 4) * (r.perimeterCm / 30.48 / 4)).round()} ${_v('sqAdi')}',
                      style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: kText),
                      overflow: TextOverflow.ellipsis),
              ),
              if (isExcellent)
