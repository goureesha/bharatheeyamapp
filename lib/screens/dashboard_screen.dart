            ...
            children: [
              ...
              AppCard(
                ...
                child: Column(children: [
                  ...
                  _tableRow([AppLocale.l('tithiLabel'), '${trAll(pan.tithi)}${pan.tithiGata.isNotEmpty ? '\n${AppLocale.l('gataGhati')}: ${pan.tithiGata} | ${AppLocale.l('sheshaGhati')}: ${pan.tithiShesha} / ${pan.tithiParama}' : ''}']),
                  _tableRow([AppLocale.l('chandraNakshatra'), () { final moonPada = r.planets['ಚಂದ್ರ']?.pada; final fallback = (pan.nakPercent * 4).floor() + 1; final p = moonPada ?? (fallback < 1 ? 1 : fallback > 4 ? 4 : fallback); return '${trAll(pan.nakshatra)} - ${AppLocale.l('padaLabel')} $p\n${AppLocale.l('gataGhati')}: ${pan.gataGhati} | ${AppLocale.l('sheshaGhati')}: ${pan.shesha} / ${pan.paramaGhati}'; }()]),
                  _tableRow([AppLocale.l('yogaLabel'), '${trAll(pan.yoga)}${pan.yogaGata.isNotEmpty ? '\n${AppLocale.l('gataGhati')}: ${pan.yogaGata} | ${AppLocale.l('sheshaGhati')}: ${pan.yogaShesha} / ${pan.yogaParama}' : ''}']),
                  _tableRow([AppLocale.l('karanaLabel'), '${trAll(pan.karana)}${pan.karanaGata.isNotEmpty ? '\n${AppLocale.l('gataGhati')}: ${pan.karanaGata} | ${AppLocale.l('sheshaGhati')}: ${pan.karanaShesha} / ${pan.karanaParama}' : ''}']),
