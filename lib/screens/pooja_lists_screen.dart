...
const Map<String, Map<String, String>> _poojaStrings = {
  ...
  'en': {
    'title': 'Pooja List', 'newList': 'New Pooja List',
    'hintName': 'Ex: Ganesha Pooja, Satyanarayana Pooja...',
    'cancel': 'Cancel', 'create': 'Create', 'save': 'Save', 'delete': 'Delete',
    'rename': 'Rename', 'noLists': 'No Pooja Lists',
    'tapCreate': 'Press + to create a new list', 'createList': 'Create List',
    'items': 'Items', 'noItems': 'No items', 'item': 'Item', 'qty': 'Quantity',
    'addItem': 'Add Item', 'selectItem': 'Select Item', 'selectQty': 'Quantity',
    'customItem': '── Custom Item ──', 'typeItemName': 'Type item name...',
    'editItem': 'Edit Item', 'itemName': 'Item Name',
    'added': 'Added', 'selectItemErr': 'Select an item',
    'purohit': 'Purohit Details', 'purohitName': 'Purohit Name', 'mobile': 'Mobile Number', 'address': 'Address', 'poojaDate': 'Pooja Date',
    'addPurohit': 'Add Purohit Name',
    'shareWA': 'Share on WhatsApp', 'downloadPdf': 'Download PDF',
    'viewPlain': 'View List', 'addDefaults': 'Add Default Items', 'removeDefaults': 'Remove Default Items',
    'deleteQ': 'Delete?', 'deleteMsg': 'This list and all items will be deleted.',
    'useDropdown': 'Use dropdown above to add', 'total': 'Total',
    'allDefaultsExist': 'All default items already exist', 'defaultsAdded': 'Default items added',
    'defaultsRemoved': 'Default items removed', 'noDefaultsToRemove': 'No default items to remove',
    'listName': 'List Name', 'poojaList': 'Pooja Samagri List', 'itemsDone': 'Items Done',
  },
};
...
const Map<String, Map<String, String>> _poojaItemTr = {
  ...
  'ml': {
    ...
    'ಶಿಂಗಾರ ಹೂ': 'അലങ്കാര പൂക്കൾ', 'ಇತರ ಹೂ': 'മറ്റ് പൂക്കൾ', 'ತುಳസി': 'തുളസി', 'ಬಿಲ್വಪತ್ರೆ': 'കൂവളത്തില',
    'ದರ್ಬೆ': 'ദർഭ', 'ಹಲಸಿನ ಕುಡಿ': 'പ്ലാവില', 'ಮಾವಿನ ಕುಡಿ': 'മാവില',
    'ರಜ್ಜു': 'രജ്ജു', 'ನೂಲುಂಡೆ': 'നൂൽ', 'ಜನಿವಾರ': 'പൂണൂൽ',
    'ವೀಳ್ಯದೆಲೆ ಕಟ್ಟು': 'വെറ്റില', 'ಅಡಿಕೆ': 'അടയ്ക്ക', 'ಬಾಳೆ ಎಲೆ': 'വാഴയില',
    'ಬಾಳೆ ಹಣ್ಣು': 'വാഴപ്പഴം', 'ಲಿಂಬെ ഹಣ್ಣു': 'ചെറുനാരങ്ങ', 'ಇತರ ಹಣ್ಣು': 'മറ്റ് പഴം',
    ...
    'ಉದ್ದು': 'ഉഴുന്ന്', 'കടലെ': 'കടല', 'ತೊಗರಿ': 'തുവര', 'ಹೆಸರು': 'ചെറുപയർ', 'ಹುರುಳಿ': 'മുതിര',
    ...
    'ಪಟ್ಟೆ ಮಡಿ': 'പട്ടെ മടി', 'ವೇಷ್ಟಿ ಪಂಚെ': 'മുണ്ട്', 'ಮುಂಡುಪಂಚെ': 'മുണ്ടുപഞ്ചെ',
    ...
    'ಅಶ್ವತ್ಥ': 'അരയാൽ', 'ಪಾಲಾಶ (ಮುತ್ತುಗ)': 'പ്ലാശ്', 'ಅತ್ತി': 'അത്തി',
    'ಕದಿರ': 'ഖദിര', 'ಶಮಿ': 'ശമി', 'ದೂರ್ವೆ': 'കറുക', 'ಎಕ್ಕೆ': 'എരിക്ക്',
    'ನವಗ್ರಹ ರತ್ನ ಸೆಟ್': 'നവഗ്രഹ രത്ന സെറ്റ്', 'ಕಾಶಿ ತೀರ್ಥ (1 ಬಾಟಲಿ)': 'കാശി തീർഥം (1 ബോട്ടിൽ)',
  },
  'en': {
    'ಅಕ್ಕಿ': 'Rice', 'ಅರಿಶಿನ': 'Turmeric', 'ಕುಂಕುಮ': 'Kumkum', 'ರಂಗೋಲಿ': 'Rangoli',
    'ಹಸಿರು ಬಣ್ಣ': 'Green color', 'ಕಪ್ಪು ಬಣ್ಣ': 'Black color', 'ಇತರ ಬಣ್ಣ': 'Other color', 'ಗಂಧ': 'Sandalwood',
    'ಶಿಂಗಾರ ಹೂ': 'Decoration flowers', 'ಇತರ ಹೂ': 'Other flowers', 'ತುಳಸಿ': 'Tulsi', 'ಬಿಲ್ವಪತ್ರೆ': 'Bilva leaves',
    'ದರ್ಬೆ': 'Darbha grass', 'ಹಲಸಿನ ಕುಡಿ': 'Jackfruit leaf', 'ಮಾವಿನ ಕುಡಿ': 'Mango leaf',
    'ರಜ್ಜು': 'Rajju', 'ನೂಲುಂಡೆ': 'Cotton thread', 'ಜನಿವಾರ': 'Janeu (Sacred thread)',
    'ವೀಳ್ಯದೆಲೆ ಕಟ್ಟು': 'Betel leaves bundle', 'ಅಡಿಕೆ': 'Betel nuts', 'ಬಾಳೆ ಎಲೆ': 'Banana leaf',
    'ಬಾಳೆ ಹಣ್ಣು': 'Banana', 'ಲಿಂಬೆ ಹಣ್ಣು': 'Lemon', 'ಇತರ ಹಣ್ಣು': 'Other fruits',
    'ತೆಂಗಿನ ಕಾಯಿ': 'Coconut', 'ಸೀಯಾಳ': 'Tender coconut', 'ಕುಂಬಳ ಕಾಯಿ': 'Ash gourd',
    'ಗೋಮಯ': 'Cow dung', 'ಗೋಮೂತ್ರ': 'Cow urine', 'ಹಾಲು': 'Milk', 'ತುಪ್ಪ': 'Ghee',
    'ಸಕ್ಕರೆ': 'Sugar', 'ಜೇನುತುಪ್ಪ': 'Honey', 'ಕಬ್ಬಿನ ಹಾಲು': 'Sugarcane juice',
    'ಊದುಬತ್ತಿ': 'Incense sticks', 'ಕರ್ಪೂರ': 'Camphor', 'ಹತ್ತಿಬತ್ತಿ ಕಟ್ಟು': 'Cotton wicks bundle', 'ದೀಪದ ಎಣ್ಣೆ': 'Lamp oil',
    'ಚಕ್ಕೆ ಹೊರೆ': 'Cinnamon stick', 'ಕರಿ ಎಳ್ಳು': 'Black sesame', 'ಬಿಳಿ ಸಾಸಿವೆ': 'White mustard',
    'ಅರಳು': 'Puffed rice', 'ಭತ್ತ': 'Paddy', 'ಗೋಧಿ': 'Wheat', 'ಅವರೆ': 'Avare beans',
    'ಉದ್ದು': 'Urad dal', 'ಕಡಲೆ': 'Chana dal', 'ತೊಗರಿ': 'Toor dal', 'ಹೆಸರು': 'Green gram', 'ಹುರುಳಿ': 'Horse gram',
    'ಜಾಯಿಕಾಯಿ': 'Nutmeg', 'ಒಣದ್ರಾಕ್ಷಿ': 'Raisins', 'ಉತ್ತುತ್ತೆ': 'Dates/Almonds',
    'ಗೋಡಂಬಿ': 'Cashews', 'ಕಾಳು ಮೆಣಸು': 'Black pepper', 'ಲವಂಗ': 'Cloves', 'ಏಲಕ್ಕಿ': 'Cardamom',
    'ಬೆಲ್ಲ': 'Jaggery', 'ಅವಲಕ್ಕಿ': 'Poha (Beaten rice)', 'ಬಾಳೆ ಎಲೆ ದೊನ್ನೆ': 'Banana leaf cup',
    'ಪಟ್ಟೆ ಮಡಿ': 'Silk dhoti', 'ವೇಷ್ಟಿ ಪಂಚೆ': 'Veshti', 'ಮುಂಡುಪಂಚೆ': 'Mundu',
    'ಸೀರೆ': 'Saree', 'ಕಣ': 'Blouse piece', 'ಶಾಲು': 'Shawl', 'ಪಾಣಿ ಪಂಚೆ': 'Pani panche', 'ಬಾತ್ ಟವಲ್': 'Bath towel',
    'ಕೊಡಪಾನ': 'Pot (Kodapana)', 'ತಂಬಿಗೆ': 'Copper pot (Tambige)', 'ಹರಿವಾಣ': 'Plate (Harivana)',
    'ಕವಳಿಗೆ ಸೌಟು': 'Spoon', 'ಹಿತ್ತಾಳೆ ಬುಟ್ಟಿ': 'Brass basket',
    'ಇಟ್ಟಿಗೆ': 'Brick', 'ಹೊಯ್ಗೆ': 'Sand', 'ಬಾಳೆ ಕಂಬ (ದಿಂಡು)': 'Banana stem',
    'ಪಂಚರತ್ನ': 'Pancharatna', 'ಕನ್ನಡಿ': 'Mirror', 'ಗೋಪಿ': 'Gopi chandan', 'ಬೆಳ್ಳಿ': 'Silver',
    'ಕಬ್ಬಿನ ಜಲ್ಲೆ': 'Sugarcane piece', '1 ರೂಪಾಯಿ ನಾಣ್ಯ': '1 Rupee coin', 'ಚಿಲ್ಲರೆ ರೊಕ್ಕ': 'Loose change',
    'ಅಶ್ವತ್ಥ': 'Peepal (Ashwattha)', 'ಪಾಲಾಶ (ಮುತ್ತುಗ)': 'Palash', 'ಅತ್ತಿ': 'Fig (Atti)',
    'ಕದಿರ': 'Khadira', 'ಶಮಿ': 'Shami', 'ದೂರ್ವೆ': 'Durva grass', 'ಎಕ್ಕೆ': 'Calotropis (Ekka)',
    'ನವಗ್ರಹ ರತ್ನ ಸೆಟ್': 'Navagraha gem set', 'ಕಾಶಿ ತೀರ್ಥ (1 ಬಾಟಲಿ)': 'Kashi Teertha (1 bottle)',
  },
};
